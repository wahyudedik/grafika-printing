...
<body>
    <script src="./dist/js/demo-theme.min.js?1738096684"></script>
    <div class="page">
        <!-- Navbar -->
                                                ...
                                                <div class="dropdown-menu-column">
                                                    ...
                                                    <div class="dropend">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a href="./sign-in-illustration.html"
                                                                class="dropdown-item">
                                                            ...
                                                            <a href="./2-step-verification.html"
                                                                class="dropdown-item">
                                                                2 step verification
                                                            </a>
                                                            <a href="./2-step-verification-code.html"
                                                                class="dropdown-item">
