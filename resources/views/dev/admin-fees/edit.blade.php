        ...
        <div class="col-12">
            <form action="{{ route('admin.admin-fees.update', $adminFee) }}" method="POST" class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">Edit Pengaturan Biaya Admin</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    ...
                                    placeholder="Contoh: Biaya Admin Lelang">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" name="category">
                                    ...
                                    <option value="auction"
                                        {{ old('category', $adminFee->category) == 'auction' ? 'selected' : '' }}>Lelang
                                    </option>
                                    <option value="payment"
                                        {{ old('category', $adminFee->category) == 'payment' ? 'selected' : '' }}>Pembayaran
                                    </option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" name="type"
                                    ...
                                    <option value="fixed" {{ old('type', $adminFee->type) == 'fixed' ? 'selected' : '' }}>
                                        Tetap (Rp)</option>
                                    <option value="percentage"
                                        {{ old('type', $adminFee->type) == 'percentage' ? 'selected' : '' }}>Persentase (%)
                                    </option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('minimum_amount') is-invalid @enderror"
                                    name="minimum_amount" value="{{ old('minimum_amount', $adminFee->minimum_amount) }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('maximum_amount') is-invalid @enderror"
                                    name="maximum_amount" value="{{ old('maximum_amount', $adminFee->maximum_amount) }}"
                                    step="0.01" min="0" placeholder="Tidak terbatas">
                                <div class="form-hint">Biaya akan dikenakan jika jumlah lelang <= nilai ini</div>
                        ...
                        <div class="mb-3">
                            <label class="form-check">
                                <input type="checkbox" class="form-check-input" name="is_active" value="1"
                                    {{ old('is_active', $adminFee->is_active) ? 'checked' : '' }}>
