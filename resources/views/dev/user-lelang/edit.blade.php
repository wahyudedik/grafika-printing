            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <form action="{{ route('admin.user-lelang.update', $profile) }}" method="POST">
                    ...
                    <div class="px-5 py-4 border-t border-gray-200 dark:border-gray-700 flex gap-3">
                        ...
                        <a href="{{ route('admin.user-lelang.show', $profile) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 font-medium text-sm transition-colors">
                            Batal
                        </a>
                    </div>
                </form>
