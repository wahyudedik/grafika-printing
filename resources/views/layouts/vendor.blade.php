...
<body class="bg-gray-50 font-sans text-gray-900 antialiased"
    ...
    @php
        ...
        if (auth()->check()) {
            ...
            if ($vendorUser) {
                ...
                $stockAlertCount = \App\Models\Vendor\StockAlert::where('vendor_id', $vendorUser->id)
                    ->where('is_read', false)
                    ->count();
                $firstLinktree = \App\Models\Vendor\Linktree::where('vendor_id', $vendorUser->id)->first();
            }
        }
        ...
        $iconChartBar = '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>';
        $iconPaintBrush = '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/></svg>';
        $iconShoppingBag = '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>';
                ...
                'items' => [
                    ...
                    [
                        ...
                        'children' => array_merge(
                            ...
                            $firstLinktree ? [
                                ['label' => 'Analytics',     'url' => route('vendor.linktree.analytics', $firstLinktree), 'route' => 'vendor.linktree.analytics'],
                                ['label' => 'Template',      'url' => route('vendor.linktree.template.index', $firstLinktree), 'route' => 'vendor.linktree.template.index'],
                                ['label' => 'Katalog Produk','url' => route('vendor.linktree.products', $firstLinktree), 'route' => 'vendor.linktree.products'],
                            ] : []
                        )
                    ],
                    [
