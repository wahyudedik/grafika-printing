        ...
        <form id="batch-form" method="POST">
            ...
            <div class="card-footer d-flex align-items-center">
                <div class="batch-actions btn-group me-3" style="display: none;">
                    ...
                    <div class="dropdown-menu">
                        <button type="button" class="dropdown-item" onclick="updateBatchCategory()">
                            Ubah Kategori
                        </button>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                window.confirmBatchDelete = function() {
                    Swal.fire({
                        title: 'Anda yakin?',
                        text: "Semua produk yang dipilih akan dihapus dan tidak dapat dikembalikan!",
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#d33',
                        cancelButtonColor: '#3085d6',
                        ...
                        if (result.isConfirmed) {
                            showLoading('Menghapus...');
                            batchForm.action = "{{ route('produk.batch-delete') }}";
                ...
                // Update category for batch items
                window.updateBatchCategory = function() {
                    const categories = @json($kategories);
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            batchForm.action = "{{ route('produk.batch-update') }}";
                            batchForm.method = "POST";

                            // Add action and category inputs
                            ...
                            categoryInput.name = 'kategori_id';
                            categoryInput.value = result.value;
                            batchForm.appendChild(categoryInput);
