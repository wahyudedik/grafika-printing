...
<div x-data="importHandler()" class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <x-ui.breadcrumb :items="[['label' => 'Linktree Management', 'url' => route('vendor.linktree.index')], ['label' => $linktree->title, 'url' => route('vendor.linktree.show', $linktree)], ['label' => 'Import Link']]" />
    ...
    <div class="max-w-3xl mx-auto space-y-5">
        ...
        <div class="bg-white rounded-xl border border-gray-200">
            <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <x.ui.button href="{{ route('vendor.linktree.export-links', $linktree) }}" variant="outline-success" size="xs">
            ...
            <div class="p-5">
                <form action="{{ route('vendor.linktree.import-links', $linktree) }}" method="POST" enctype="multipart/form-data" id="importForm">
                    ...
                    <div class="flex items-center justify-between">
                        <x.ui.button href="{{ route('vendor.linktree.show', $linktree) }}" variant="ghost" size="sm">Batal</x.ui.button>
                        <x.ui.button type="submit" :disabled="!fileSelected" id="submitBtn">
                            <i class="fas fa-file-import mr-1"></i>Import Link
                        </x.ui.button>
                    </div>
                </form>
            </div>
