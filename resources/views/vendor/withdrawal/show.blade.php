                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-actions">
                            ...
                            <form action="{{ route('vendor.withdrawal.cancel', $withdrawal) }}" method="POST" class="d-inline"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="mt-1">
                                ...
                                @elseif($withdrawal->status === 'rejected')
                                    ...
                                    <p class="text-muted small mt-2">Penarikan Anda ditolak. Silakan hubungi admin untuk informasi lebih lanjut.</p>
                                @elseif($withdrawal->status === 'cancelled')
                        ...
                        <div class="text-muted small">
                            <p class="mb-1">• Penarikan diproses dalam 1-3 hari kerja</p>
                            <p class="mb-1">• Anda akan menerima notifikasi setelah diproses</p>
                            <p class="mb-0">• Hubungi admin jika ada pertanyaan</p>
                        </div>
                    </div>
                </div>
            </div>
