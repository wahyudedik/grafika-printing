...
<div class="page-header d-print-none">
    <div class="row align-items-center">
        <div class="col-auto">
            ...
            <h2 class="page-title">Riwayat Penarikan</h2>
        </div>
        <div class="col-auto ms-auto">
            <a href="{{ route('vendor.withdrawal.index') }}" class="btn btn-outline-primary me-2">
                Kembali
            </a>
    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Semua Riwayat Penarikan</h3>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-muted">Rp {{ number_format($withdrawal->fee ?? 0, 0, ',', '.') }}</span>
                                </td>
                                <td>
                                    <span class="fw-bold text-success">Rp {{ number_format($withdrawal->net_amount ?? ($withdrawal->amount - ($withdrawal->fee ?? 0)), 0, ',', '.') }}</span>
                                </td>
                                <td>
                ...
                <div class="empty">
                    ...
                    <p class="empty-subtitle text-muted">Riwayat penarikan Anda akan muncul di sini</p>
