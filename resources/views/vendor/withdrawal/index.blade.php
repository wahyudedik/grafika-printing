...
@section('content')
<x-ui.breadcrumb :items="[['label' => 'Penarikan Dana']]" />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl border border-gray-200">
            <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <x.ui.button href="{{ route('vendor.withdrawal.history') }}" variant="ghost" size="xs">Lihat Semua →</x.ui.button>
            </div>
            <div class="p-5">
                ...
                <div class="text-center py-12">
                    ...
                    <x.ui.button href="{{ route('vendor.withdrawal.create') }}" variant="primary" class="mt-4">
                        Ajukan Penarikan
                    </x.ui.button>
                </div>
                @endif
