    ...
    <div class="container-xl">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="{{ route('vendor.laporan.export-penjualan', ['type' => 'monthly', 'date' => $selectedMonth->format('Y-m')]) }}"
        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('vendor.laporan.penjualan-bulanan') }}" method="GET" class="row g-3">
                            <div class="col-md-4">
        ...
        <div class="row mt-3">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Ringkasan Penjualan {{ $selectedMonth->format('F Y') }}</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                    @forelse($produkTerlaris as $index => $produk)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ is_array($produk) ? $produk['nama_produk'] : $produk->nama_produk }}</td>
                                            <td class="text-end">
                                                {{ is_array($produk) ? $produk['total_qty'] : $produk->total_qty }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                            ...
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                    @forelse($transaksis->take(5) as $transaksi)
                                        <tr>
                                            <td>{{ $transaksi->tanggal_dibuat->format('d M') }}</td>
